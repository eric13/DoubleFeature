...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		...
		<div class="entry-content">
			<p><?php _e( 'No results were found for the requested archive. Searching could find a related post.', 'twentyten' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</div><!-- #post-0 -->
<?php endif; ?>
...
<?php /* How to display all other posts. */ ?>
        ...
        <?php if ( is_archive() || is_search() ) : // Display the full content on archive and search. ?>
                        <h2 class="entry-title archive-page"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>

                        <div class="entry-meta archive-page">
                                <?php twentyten_posted_on(); ?>
                        </div><!-- .entry-meta -->
                        <div class="entry-content archive-page">
								<?php
									if (has_post_thumbnail()) {
										// Show the featured thumbnail
										...
										echo "<img src='". $featuredImageThumb ."' alt='". get_the_title() ."'>";
									}
								?>
                                <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'twentyten' ) ); ?>
        ...
        <?php endif; ?>
			<div class="entry-utility">
				...
				<?php
					...
					if ($showCats && count( get_the_category() )) {
