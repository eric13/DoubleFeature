	...
	if ( $slides->post_count > 0 ) {
		...
		echo "
			<div class='carousel-cell is-selected' style='position: absolute; left: 90.67%;'><!-- post loop -->
				<div rel='/subscribe'>
					<a href='/subscribe' class='needsclick' rel='nofollow'><img alt='Double Feature Podcast' src='/images/podcast-coverart-500x500.jpg' class='sliderLogoDF'></a>
					<p class='featured-title heading-font' id='sliderDescMain'>In this free weekly podcast, Eric Thirteen and Michael Koester discuss two movies in-depth.</p>
        				<a href='/subscribe' id='mainSubscribe'>Subscribe</a>
				</div>
			</div>";
